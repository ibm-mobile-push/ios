...
/** The patch:headers:payload:completion: method sends the PATCH HTTP method to the specified URL.
...
/** The get:headers:completion: method sends the GET HTTP method to the specified URL.
...
/** The post:headers:payload:completion: method sends the POST HTTP method to the specified URL.
...
/** The put:headers:payload:completion: method sends the PUT HTTP method to the specified URL.
...
/** The delete:headers:payload:completion: method sends the DELETE HTTP method to the specified URL.
